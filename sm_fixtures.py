...
print("API CALL Round & Fixtures: " + str(response.status_code))
...
for fixture in data_match:
    ...
    # if the fixture has more stats added
    if fixture['round']['data']['name'] in spieltage_mit_stats:        
        ...
        # if the fixture has advanced stats added
...
columns_names_fixture_stats += ['attacks', 'dangerous_attacks','ball_safe','corners','fouls', 'free_kick',
                                ...
                                'shots_blocked', 'substitutions', 'throw_in', 'redcards', 'yellowcards', 'yellowredcards'] #28 * 2 =56
